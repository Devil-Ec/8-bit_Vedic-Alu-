...
HD_PWD='C:/Users/sarth/Documents/Mini_Project/Vedic_ALU/Vedic_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vedic_alu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vedic_alu.tcl -notrace
